...
describe('QTI1 assessment parser', () => {
  describe('parse', () => {
    ...
    it('parses "MIT" assessment xml from QTI into an object', () => {
      ...
      xml.find('assessment').addBack('assessment');
      ...
      const item = assessment.sections[0].items[0];
    ...
    it('parses the "Financial Markets and System" assessment xml from QTI into an assessment object', () => {
      const data          = readFixture('qti1/text.xml');
      const xml           = $(data);
      ...
      const item = assessment.sections[1].items[0];
  ...
  describe('parseSections', () => {
    ...
    it('find sections in the given qti', () => {
      const data = readFixture('qti1/cells.xml');
      const sections = Parser.parseSections($(data));
